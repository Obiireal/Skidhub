...
function CheckQuest() 
    ...
    if World1 then
        ...
        elseif MyLevel == 10 or MyLevel = 11 or Mylevel = 12 or Mylevel = 13 or Mylevel = 14 or Mylevel = 16 or Mylevel = 18 or Mylevel = 20 or Mylevel = 22 or Mylevel = 24 or Mylevel = 26 or Mylevel = 28 then
            Mon = "Monkey"
            LevelQuest = 1
